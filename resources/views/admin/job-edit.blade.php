...
<div class="page-title">
  <div class="container">
    <div class="page-caption">
      <h2>Add Job</h2>
      <p><a href="{{url('/')}}" title="Home">Home</a> <i class="ti-angle-double-right"></i><a href="{{route('admin.dashboard')}}" title="Home">Dashboard</a> <i class="ti-angle-double-right"></i> Edit Job</p>
    </div>
  </div>
</div>
<!-- ======================= End Page Title ===================== --> 
...
<section class="create-job padd-top-80 padd-bot-80">
  <div class="container" data-aos="fade-up">
    <form class="c-form" action="{{ route('admin.jobs.update', $job->id) }}" method="POST" enctype="multipart/form-data">
       @csrf
       @method('PUT')
      <!-- General Information -->
      <div class="box">
