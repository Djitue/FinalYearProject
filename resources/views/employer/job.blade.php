      ...
      <table class="table table-lg table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{route('jobs.edit', $job->id)}}" class="cl-success mrg-5" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a> 
              <a href="{{ route('job.matches', ['id' => $job->id]) }}" class="cl-success mrg-5" data-toggle="tooltip" title="View Matches">
